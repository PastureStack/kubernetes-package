...
The patches in this directory apply only to the Kubernetes `v1.12.10`
compatibility source at commit
`71fde6aadce8b92456b88ee56c21e500f4919f0b`.

The immutable commit and archive digest retain source provenance without using
a branded version suffix. All six rebuilt executables report the independent
numeric maintenance version configured by `KUBERNETES_BINARY_VERSION`.
